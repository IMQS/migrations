...
CREATE TABLE "WaterAuxAppurtenance_02" (
 "rowid" BIGSERIAL,
 "Locality" VARCHAR,
 "MetaID" INTEGER,
 "ID" UUID,
...
CREATE INDEX ON "WaterAuxAppurtenance_02" USING GIST ("Geometry");
CREATE UNIQUE INDEX ON "WaterAuxAppurtenance_02" ("ID");
...
CREATE TABLE "WaterAuxAppurtenance_04" (
 "rowid" BIGSERIAL,
 "Locality" VARCHAR,
 "MetaID" INTEGER,
 "ID" UUID,
...
CREATE INDEX ON "WaterAuxAppurtenance_04" USING GIST ("Geometry");
CREATE UNIQUE INDEX ON "WaterAuxAppurtenance_04" ("ID");
...
CREATE TABLE "WaterAuxHouseConnectionUser_02" (
 "rowid" BIGSERIAL,
 "Locality" VARCHAR,
 "MetaID" INTEGER,
 "ID" UUID,
...
CREATE UNIQUE INDEX ON "WaterAuxHouseConnectionUser_02" ("ID");
...
CREATE TABLE "WaterAuxHouseConnectionUser_04" (
 "rowid" BIGSERIAL,
 "Locality" VARCHAR,
 "MetaID" INTEGER,
 "ID" UUID,
...
CREATE UNIQUE INDEX ON "WaterAuxHouseConnectionUser_04" ("ID");
...
CREATE TABLE "WaterAuxHouseConnection_02" (
 "rowid" BIGSERIAL,
 "Locality" VARCHAR,
 "MetaID" INTEGER,
 "ID" UUID,
...
CREATE INDEX ON "WaterAuxHouseConnection_02" USING GIST ("Geometry");
CREATE UNIQUE INDEX ON "WaterAuxHouseConnection_02" ("ID");
...
CREATE TABLE "WaterAuxHouseConnection_04" (
 "rowid" BIGSERIAL,
 "Locality" VARCHAR,
 "MetaID" INTEGER,
 "ID" UUID,
...
CREATE INDEX ON "WaterAuxHouseConnection_04" USING GIST ("Geometry");
CREATE UNIQUE INDEX ON "WaterAuxHouseConnection_04" ("ID");
...
DROP TABLE "WaterAuxAppurtenance_AsBuilt";
DROP TABLE "WaterAuxAppurtenance_Existing";
DROP TABLE "WaterAuxHouseConnectionUser_AsBuilt";
DROP TABLE "WaterAuxHouseConnectionUser_Existing";
DROP TABLE "WaterAuxHouseConnection_AsBuilt";
DROP TABLE "WaterAuxHouseConnection_Existing";
